...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FFD700] text-black font-body selection:bg-black selection:text-[#FFD700] overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-[-1]">
        <motion.div 
          ...
          className="absolute top-[10%] left-[5%] text-8xl opacity-10"
        >
          💦
        </motion.div>
        <motion.div 
          ...
          className="absolute bottom-[20%] right-[10%] text-9xl opacity-10"
        >
          👅
        </motion.div>
        <motion.div 
          ...
          className="absolute top-[40%] right-[5%] text-7xl opacity-10"
        >
          ✨
        </motion.div>
      </div>
